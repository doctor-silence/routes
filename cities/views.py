...
class CityCreateView(SuccessMessageMixin, CreateView):   #Добавление города
    model = City
    form_class = CityForm
...
class CityUpdateView(SuccessMessageMixin, UpdateView):   #Изменение/ Добавляем миксин для сообщений
    model = City
    form_class = CityForm
