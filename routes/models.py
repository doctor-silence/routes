...
class Route(models.Model):   #Создаем модель "поезд"
    ...
    from_city = models.ForeignKey(City, on_delete=models.CASCADE, related_name='route_from_city_set', verbose_name='Из какого города')  #Связываем таблицу с таблицей City.
